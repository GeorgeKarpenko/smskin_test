...
!(function webpackMissingModule() { var e = new Error("Cannot find module '../Components/Article.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module '../Components/Pagination.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    Article: !(function webpackMissingModule() { var e = new Error("Cannot find module '../Components/Article.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    Pagination: !(function webpackMissingModule() { var e = new Error("Cannot find module '../Components/Pagination.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  methods: {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("Article", { attrs: { articles: _vm.articles } }),
      _vm._v(" "),
      _c("Pagination", { attrs: { number_of_pages: _vm.number_of_pages } })
    ],
    1
  )
}
